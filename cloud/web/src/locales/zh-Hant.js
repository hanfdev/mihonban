...
export default {
  ...
  artistPage: {
    ...
    nameDialog: '編輯藝人名稱',
    nameLabel: '藝人名稱',
    nameHint: '將同步更新此藝人在所有專輯和曲目中的名稱，頭像、簡介和收藏會保留。',
    nameAliasHint: '舊名稱仍可用於開啟藝人連結和比對後續匯入。',
    nameRequired: '請輸入藝人名稱。',
    nameInvalid: '請輸入 1–500 個字元的單行名稱。',
    nameConflict: '此名稱已被其他藝人使用，請選擇不同的名稱。',
    nameTooLong: '此名稱會使既有合作署名過長，請縮短名稱。',
    nameChanged: '藝人資料已發生變更，請重新整理頁面後再試。',
    nameSaved: '藝人名稱已更新',
