...
Dans un même stockage nommé, l’identité des dossiers d’album et des chemins de morceau est insensible à la casse. Les chemins enregistrés sont conservés et les doublons ultérieurs qui ne diffèrent que par la casse sont refusés.

L’identité des artistes est insensible à la casse dans tout le catalogue. Les administrateurs peuvent renommer un artiste depuis son profil ou corriger les majuscules et minuscules dans les crédits d’album et de morceau. Une seule transaction met à jour la fiche artiste, tous les crédits, les crédits d’import enregistrés, les notes et les correspondances des anciens noms. Le profil, les favoris, les identifiants des albums et des morceaux et les chemins de stockage sont conservés. Les anciens noms pointent directement vers l’artiste actuel pour les liens et les imports ; les renommages successifs ne créent pas de chaînes d’alias. Un conflit avec un artiste existant ou l’ancien nom d’un autre artiste renvoie HTTP 409 sans fusionner les fiches. La mise à niveau à l’exécution ajoute la table indexée `artist_aliases`, incluse dans les exports logiques SQLite pour préserver les anciens liens et la correspondance des imports après restauration.
