...
`artist_sort` es opcional: los valores vacíos se conservan al exportar e importar, mientras que la búsqueda y la ordenación usan el nombre original como alternativa en tiempo de ejecución.
