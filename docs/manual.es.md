...
Para corregir mayúsculas y minúsculas, edita el nombre de un artista existente en el editor de álbumes o pistas. Al guardar, la nueva grafía se aplica al mismo artista en toda la biblioteca, incluidos los álbumes ocultos y las colaboraciones, y se conservan su perfil, los favoritos y las rutas de almacenamiento. Las importaciones y los nuevos escaneos reutilizan el nombre corregido. Elegir otro artista solo cambia ese crédito. Un aviso indica el alcance del cambio antes de guardar.
