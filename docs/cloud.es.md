...
La identidad de los artistas tampoco distingue mayúsculas y minúsculas en todo el catálogo. Las importaciones y los nuevos escaneos reutilizan el nombre visible guardado. Los administradores pueden corregir las mayúsculas y minúsculas de un artista existente en el editor de álbumes o pistas; una sola transacción actualiza la ficha del artista, los créditos de álbumes y pistas, los créditos de importación guardados y las notas del artista. Las importaciones posteriores usan el nombre corregido. Se conservan el perfil, los favoritos, los identificadores de álbumes y pistas y las rutas de almacenamiento. Si los datos antiguos contienen fichas de artista en conflicto que solo difieren en el uso de mayúsculas, la edición devuelve HTTP 409 sin fusionarlas. Estas correcciones no requieren una migración del esquema de la base de datos.
