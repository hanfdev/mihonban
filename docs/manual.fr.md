...
Pour corriger les majuscules et minuscules, modifiez le nom d’un artiste déjà présent dans l’éditeur d’album ou de morceau. Cette graphie s’applique au même artiste dans toute la bibliothèque, y compris les albums masqués et les participations, tout en conservant son profil, les favoris et les chemins de stockage. Les imports et les nouvelles analyses réutilisent le nom corrigé. Choisir un autre artiste ne modifie que le crédit concerné. Une indication précise la portée du changement avant l’enregistrement.
